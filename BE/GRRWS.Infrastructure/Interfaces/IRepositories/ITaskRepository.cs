...
namespace GRRWS.Infrastructure.Interfaces.IRepositories
{
    public interface ITaskRepository : IGenericRepository<Tasks>
    {
        ...
        Task<(List<GetGroupTaskResponse> Groups, int TotalCount)> GetAllGroupTasksByMechanicIdAsync(int pageNumber, int pageSize, Guid mechanicId);
        ...
        Task<Tasks> GetByTaskGroupIdAndTypeAsync(Guid taskGroupId, TaskType taskType);
    }
}
