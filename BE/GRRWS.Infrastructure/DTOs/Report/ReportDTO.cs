...
namespace GRRWS.Infrastructure.DTOs.Report
{
    ...
    public class ReportWarrantyCreateDTO
    {
        public Guid? RequestId { get; set; }
        public int Priority { get; set; }
    ...
    public class ReportViewDTO
    {
        ...
        public List<SymtomsSummaryDTO> TechnicalSymptoms { get; set; }
    }
    ...
    public class SymtomsSummaryDTO
    {
        public Guid TechnicalSymtomId { get; set; }
        public string Name { get; set; }
    }
}
