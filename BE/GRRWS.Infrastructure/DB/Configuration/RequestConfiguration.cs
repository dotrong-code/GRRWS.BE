...
namespace GRRWS.Infrastructure.DB.Configuration
{
    public class RequestConfiguration : IEntityTypeConfiguration<Request>
    {
        public void Configure(EntityTypeBuilder<Request> builder)
        {
            ...
            builder.HasData(
                // Request 1: Thread Break on Juki DDL-8700 Unit 1 (Sewing Line A)
                new Request
                {
                    Id = Guid.Parse("a1f2e3d4-0001-0001-0001-000000000001"),
                    ...
                    RequestedById = Guid.Parse("32222222-2222-2222-2222-222222222222"), // Head of Team
                    ReportId = null,
                    CreatedDate = DateTime.UtcNow,
                    ModifiedDate = DateTime.UtcNow,
                    IsDeleted = false
                },
                // Request 2: Motor Failure on Juki DDL-8700 Unit 4 (Sewing Line A)
                new Request
                {
                    Id = Guid.Parse("a1f2e3d4-0002-0002-0002-000000000002"),
                ...
                // Request 3: Needle Jam on Juki DDL-8700 Unit 7 (Sewing Line B)
                new Request
                {
                    Id = Guid.Parse("a1f2e3d4-0003-0003-0003-000000000003"),
                ...
                // Request 4: Calibration Issue on Juki DDL-9000C Unit 1 (Sewing Line B)
                new Request
                {
                    Id = Guid.Parse("a1f2e3d4-0004-0004-0004-000000000004"),
                ...
                // Request 5: Overlock Issue on Brother B957 Unit 1 (Overlock Section)
                new Request
                {
                    Id = Guid.Parse("a1f2e3d4-0005-0005-0005-000000000005"),
                ...
                // Request 6: Power Issue on Singer 4452 Unit 1 (Heavy Duty Stitching Zone)
                new Request
                {
                    Id = Guid.Parse("a1f2e3d4-0006-0006-0006-000000000006"),
                    ...
                    RequestedById = Guid.Parse("23333333-3333-3333-3333-333333333343"), // Head of Tech 2
                    ReportId = null,
                    CreatedDate = DateTime.UtcNow,
                    ModifiedDate = DateTime.UtcNow.AddHours(1),
                    IsDeleted = false
                },
                // Request 7: Maintenance Check on Juki DDL-8700 Unit 9 (Sewing Line C)
                new Request
                {
                    Id = Guid.Parse("a1f2e3d4-0007-0007-0007-000000000007"),
                ...
                // Request 8: Thread Tension Issue on Juki DDL-9000C Unit 2 (Sewing Line C)
                new Request
                {
                    Id = Guid.Parse("a1f2e3d4-0008-0008-0008-000000000008"),
                ...
                // Request 9: Repair Request for Juki DDL-8700 Unit 3 (InRepair)
                new Request
                {
                    Id = Guid.Parse("a1f2e3d4-0009-0009-0009-000000000009"),
                ...
                // Request 10: Belt Issue on Singer 4452 Unit 2 (Heavy Duty Stitching Zone)
                new Request
                {
                    Id = Guid.Parse("a1f2e3d4-0010-0010-0010-000000000010"),
                ...
                // Request 11: Lubrication Needed on Brother B957 Unit 2 (Overlock Section)
                new Request
                {
                    Id = Guid.Parse("a1f2e3d4-0011-0011-0011-000000000011"),
                    ...
                    RequestedById = Guid.Parse("23333333-3333-3333-3333-333333333344"), // Head of Tech 3
                    ReportId = null,
                    CreatedDate = DateTime.UtcNow,
                    ModifiedDate = DateTime.UtcNow.AddHours(2),
                    IsDeleted = false
                },
                // Request 12: Software Update on Juki DDL-9000C Unit 4 (Sewing Line C)
                new Request
                {
                    Id = Guid.Parse("a1f2e3d4-0012-0012-0012-000000000012"),
                ...
                // Request 13: Repair Request for Singer 4452 Unit 3 (InRepair)
                new Request
                {
                    Id = Guid.Parse("a1f2e3d4-0013-0013-0013-000000000013"),
                ...
                // Request 14: Noise Issue on Juki DDL-8700 Unit 8 (Sewing Line B)
                new Request
                {
                    Id = Guid.Parse("a1f2e3d4-0014-0014-0014-000000000014"),
                ...
                // Request 15: Cleaning Request for Brother B957 Unit 3 (Overlock Section)
                new Request
                {
                    Id = Guid.Parse("a1f2e3d4-0015-0015-0015-000000000015"),
