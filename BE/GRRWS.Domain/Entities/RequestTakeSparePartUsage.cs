...
namespace GRRWS.Domain.Entities
{
    public class RequestTakeSparePartUsage : BaseEntity
    {
        ...
        public Guid? AssigneeId { get; set; } // ID của người lấy (liên kết với User hoặc Employee)
        public SparePartRequestStatus Status { get; set; } = SparePartRequestStatus.Unconfirmed; // Trạng thái
        ...
        public User? Assignee { get; set; } // Quan hệ với người lấy
